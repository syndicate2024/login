...
const Dashboard = () => {
  ...
  const navItems = [
    ...
    },
    {
      ...
      active: activeSection === "Learning Progress",
    },
    ...
    },
    {
      ...
      active: activeSection === "Recent Activity",
    },
  ];

  return (
    <div className="relative min-h-screen bg-[#0A0F1B]">
      ...
      {/* Top Navigation Bar with enhanced glass effect */}
      <nav
        className="fixed top-0 left-0 right-0 z-50 px-4 py-3 border-b bg-black/40 backdrop-blur-xl border-white/10
                    before:absolute before:inset-0 before:bg-gradient-to-r before:from-[#FF2E97]/10 before:to-[#00F6FF]/10"
      >
       
        <motion.div className="fixed top-0 left-0 z-40 h-full pt-20...">
          {/* Menu Toggle & Title */}
          ...
          {/* User Controls with enhanced effects */}
          <div className="flex items-center gap-4">
            <motion.div
              className="flex items-center gap-2 p-2 border rounded-lg bg-black/20 backdrop-blur-lg border-white/10"
              whileHover={{ scale: 1.02 }}
            >
              <div className="w-10 h-10 p-[2px] rounded-full bg-gradient-to-r from-[#FF2E97] to-[#00F6FF] relative group">
            ...
            {/* Logout Button with enhanced gradient effect */}
            <motion.button
      ...
      {/* Enhanced Sidebar with circuit pattern */}
      <motion.div
        className="fixed top-0 left-0 z-40 h-full pt-20 border-r bg-black/40 backdrop-blur-xl border-white/10
                   before:absolute before:inset-0 before:bg-gradient-to-b before:from-[#FF2E97]/10 before:to-[#00F6FF]/10"
        animate={{
